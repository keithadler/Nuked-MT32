...
protected:
	i8x9x_device(mt32_t* _mt32);

	virtual void do_exec_full() override;
	virtual void do_exec_partial() override;
	virtual void internal_update(u64 current_time) override;
	virtual void check_hso_irq() override;
	...
	virtual void reg_write(uint8_t addr, uint8_t data) override;
	virtual uint8_t reg_read(uint8_t addr) override;
